...
class TextMultiKernalCnn(tf.keras.Model):
    def __init__(self, vocab_size, embed_size, class_num):
        ...
        self.conv_layer2 = layers.Conv1D(filters=32, kernel_size=3, activation='relu', padding='same')
        self.pool_layer2 = layers.GlobalMaxPool1D()
        self.conv_layer3 = layers.Conv1D(filters=32, kernel_size=3, activation='relu', padding='same')
